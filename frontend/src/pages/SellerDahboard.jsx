  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="bg-white rounded-xl shadow p-6 mb-8">
        <h2 className="text-xl font-semibold mb-2">{vendor.companyName}</h2>
        ...
        <p className="text-sm text-gray-600">
          Address: {vendor.address.line}, {vendor.address.city}, {vendor.address.postalCode}, {vendor.address.country}
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white p-4 rounded-xl shadow text-center">
          ...
          <h2 className="text-base font-mono text-gray-600">{vendor.vendorId}</h2>
        </div>
      </div>
